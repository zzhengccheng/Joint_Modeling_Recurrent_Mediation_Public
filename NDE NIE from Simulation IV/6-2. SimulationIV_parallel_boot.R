...
estvar=read.table(paste("covIVlog",as.character(simseed+1),".txt",sep=""),header=FALSE,row.names=1,na.strings = ".")
...
write.csv(myBest,paste("BootIV_lres",as.character(simseed+1),"batch=", as.character(bootbatch),".csv",sep=""),row.names=FALSE)
