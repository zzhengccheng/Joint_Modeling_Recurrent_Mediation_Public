...
betaz=est$betaz
betax=c(est$betax1,est$betax2,est$betax3,est$betax4,est$betax5)
...
cov1=read.table("covI_real.txt",row.names=1)
...
for (batch in 1:20){
  ...
  Bbetaz=Best[23]
  Bbetax=Best[c(21:22,24:26)]
  Betaz=Best[29]
  Betax=Best[c(27:28,30:32)]
  Bdelta1=Best[33]
  Bdelta2=0
  Betam=Best[34]
...
write.csv(Bres1_new,paste("Bres_trt",as.character(1111+simseed),"batch=",as.character(batch),".csv",sep=""),row.names=FALSE)
}
}
