...
res=NULL
for (mm in 1:MM){
  res=read.csv(paste("Res_trt",as.character(1111),"batch=",as.character(mm-1),".csv",sep=""))
...
for (mm in 1:Ba_tmp){
  Bres_tmp=read.csv(paste("Bres_trt",as.character(1111+sim-1),"batch=",as.character(mm),".csv",sep=""))
...
###Plot the NDE/NIE/TE ##
pdf("Effects_mod1_trt_95quantile_final.pdf")
